/**
 * Toonflow AI 供应商模板 - New-API(本地聚合接口)
 * @version 1.0
 */
...
const vendor: VendorConfig = {
  ...
  author: "Toonflow",
  name: "New-API(本地聚合接口)",
  description: "本地聚合 AI 接口，支持多种主流模型",
  inputs: [
    { key: "apiKey", label: "API 密钥", type: "password", required: true },
    { key: "baseUrl", label: "请求地址", type: "url", required: true, placeholder: "示例：http://127.0.0.1:3000/v1" },
  ],
  inputValues: {
    apiKey: "",
  ...
  models: [
    ...
    { name: "Qwen 3.5 Plus", modelName: "qwen3.5-plus", type: "text", think: false },
