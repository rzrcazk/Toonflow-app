...
- **时长放宽**：一镜到底镜头因信息量持续更新，可突破单镜 5s 上限，但不超过 10s
...
- 2~3s 镜头：最多 1 拍；4~5s 镜头：最多 2 拍；一镜到底（6~10s）：最多 3 拍
...
**duration**：基础参考——特写/表情 2~3s · 对话近景 3~5s · 全身亮相 3~5s · 动作 2~4s · 远景/空镜/过渡 3~5s · 复杂场景 5s。**单镜不超过 5s**，超过须拆分为多个分镜。
