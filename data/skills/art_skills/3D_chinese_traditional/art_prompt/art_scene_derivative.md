...
| 布局 | 单画面（非拼图、非多视图、非分屏） |
| 人物 | 使用正向空场描述：空置居室/空置庭院/无人场景。不要反复堆叠人物负向词 |
...
古风衍生场景图，基于参考图，
国风3D环境概念图，高精度建模，PBR材质，电影级柔和光影，体积光，自然光照，物理光影，
...
> **即梦/Seedream 兼容要求**：提示词以清晰自然语言为主，避免重复堆叠同义风格词、英文负向词和镜头后期词。无人场景只写一次"空置场景，无人物"即可。
> **空场叙事安全要求**：室内床榻、衣物、被褥等元素只能描述为生活化陈设和自然使用痕迹；避免"抓握、滑落、受压、动作痕迹、人体轮廓"等容易被理解为规避式暧昧描写的词。
...
| R6 | 场景图使用"空置场景，无人物"表达，不重复堆叠人物负向词 |
| R7 | 根据用户提供的信息自行判断变化维度（角度/景别/时段/天候），未提及维度留空省略 |
| R8 | 必须包含3D渲染关键词（国风3D/体积光/PBR材质 等，避免中英文重复堆叠） |
| R9 | 必须包含镜头光学特征（depth of field / bokeh 至少一项） |
...
| X2 | 天候与季节矛盾（夏天飞雪等） |
| X3 | 变体间材质/风格突变 |
| X4 | 出现人物，或在提示词中反复强调人影/人体剪影/人体轮廓 |
...
| X9 | 床榻/衣物/被褥场景使用"抓握、滑落、受压、动作痕迹、人体轮廓"等高风险暧昧暗示词 |
