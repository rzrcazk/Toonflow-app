...
- 低于 4s 的节拍不得单独成镜；应合并进前后相邻镜头，或延长为 4s 以上
- 4~6s 镜头：最多 2 拍；7s+ 镜头：最多 3 拍
...
**duration**：基础参考——特写/表情 4s · 对话近景 4~6s · 全身亮相 4~6s · 动作 4~6s · 远景/空镜/过渡 4~6s · 复杂场景 5~8s。**即梦 / Seedance 视频单条分镜不得低于 4s**；低于 4s 的表情、动作、物件特写必须合并进相邻镜头或延长到 4s 以上。**单镜不超过 8s**，超过须拆分。
...
- 若项目使用即梦 / Seedance，最终 `duration` 仍小于 4s 时，必须上调为 4s 或与相邻镜头合并
...
- **同场戏内**：镜头间默认硬切
- **跨场景**：插入 1 个空镜分镜（4~5s）做情绪缓冲，空镜内容与前后场景氛围相关；即梦 / Seedance 下禁止 4s 以下过渡镜
